...
public class DOStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let completeColor: UIColor = UIColor(red: 0.314, green: 0.824, blue: 0.761, alpha: 1.000)
    ...
    public class var completeColor: UIColor { return Cache.completeColor }
    ...
    public class func drawDOTaskProgressView(numberOfTasksToDisplay numberOfTasksToDisplay: CGFloat = 10, numberOfTasksTotal: CGFloat = 20, statusText: String = "SNOOZED") {
        ...
        //// Label Drawing
        let labelRect = CGRect(x: 0, y: 58, width: 75, height: 11)
        ...
        let numberOfTasksTextRect = CGRect(x: 0, y: 4, width: 75, height: 46)
        ...
        let progressBackgroundPath = UIBezierPath(ovalInRect: CGRect(x: 23, y: 84, width: 30, height: 30))
        ...
        if statusText == "COMPLETED" {
            DOStyleKit.completeColor.setStroke()
        } else  if  statusText == "OVERDUE" {
            DOStyleKit.overdueColor.setStroke()
        } else {
        ...
        //// Point Drawing
        let pointPath = UIBezierPath(ovalInRect: CGRect(x: 34.5, y: 95.5, width: 7, height: 7))
        if statusText == "COMPLETED" {
            DOStyleKit.completeColor.setFill()
        } else  if  statusText == "OVERDUE" {
            DOStyleKit.overdueColor.setFill()
        } else {
            DOStyleKit.snoonzedColor.setFill()
        }
        pointPath.fill()
    }
